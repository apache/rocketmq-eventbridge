...
public class EventBusListenerCommon extends AbstractEventCommon {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EventBusListenerCommon.class);

    private String listenerFileName = System.getProperty("user.home") + "/listenerBM.log";
    ...
    private void init() {
        executorService = new ScheduledThreadPoolExecutor(1,
                new BasicThreadFactory.Builder().namingPattern("BenchmarkTimerThread-listener-%d").build());
