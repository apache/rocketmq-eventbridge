...
public enum FiltterPatternErrorCode implements BaseErrorCode {
    ...
    EventRuleFilterPatternExceedLimit(409, "EventRuleFilterPatternExceedLimit",
        "The filter pattern [{0}] exceed the limit [{1}]"),
    ;
    ...
    FiltterPatternErrorCode(int httpCode, String code, String s) {
