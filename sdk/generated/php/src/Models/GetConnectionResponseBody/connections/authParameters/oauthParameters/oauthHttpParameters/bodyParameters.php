...
namespace RocketMQ\Eventbridge\SDK\Models\GetConnectionResponseBody\connections\authParameters\oauthParameters\oauthHttpParameters;
...
class bodyParameters extends Model {
    ...
    /**
     * @description The key in the request body.
     * @example name
     * @var string
     */
    public $key;
    ...
    /**
     * @description The value of the key in the request body.
     * @example demo
     * @var string
     */
    public $value;
