...
namespace RocketMQ.Eventbridge.SDK.Models
{
    ...
    public class CreateApiDestinationRequest : TeaModel {
        ...
        public class CreateApiDestinationRequestHttpApiParameters : TeaModel {
            ...
            [Validation(Required=false)]
            public List<CreateApiDestinationRequestHttpApiParametersApiParameters> ApiParameters { get; set; }
            public class CreateApiDestinationRequestHttpApiParametersApiParameters : TeaModel {
                [NameInMap("name")]
                [Validation(Required=false)]
